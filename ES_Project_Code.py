...
#                                                                                                                                                      #
#  Objective: The main idea of the project is to use Image Processing to control the 
# movement of the Robotic car. Depending on what image is captured, 
#
...
#
#             the image and store it and then using template matching the correct 
# direction is determined and the movement of the robotic car          
#
#             is controlled.                                                                                                                           #
#                                                                                                                                                      #                         
